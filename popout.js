...
document.querySelector('.new-item button').addEventListener('click',function(){
  ...
  if(itemName != ''){
    ...
    var itemsStorage = localStorage.getItem('todo-items'); // string '[]'
...
function itemDelete(index){
    ...
    document.querySelector('ul.todo-items li[data-itemindex="'+index+'"]').className='rejected';
}
